...
from utils import handle_arithmetic_abstract_value
...
class AbstractEnvironment :
    ...
    We thus may pay attention to assignation and update (+ arithmetic) operations  on variables, as they could cause an IndexOutOfBoundsException
    ...
    def variable_sum_assign_flow_function(self, symbol, assigned_variable1, assigned_variable2):
        ...
        self.abs_env[symbol] = handle_arithmetic_abstract_value(self.abs_env[assigned_variable1], '+', self.abs_env[assigned_variable2])
    ...
    def variable_sub_assign_flow_function(self, symbol, assigned_variable1, assigned_variable2):
        ...
        self.abs_env[symbol] = self.abs_env[symbol] = handle_arithmetic_abstract_value(self.abs_env[assigned_variable1], '-', self.abs_env[assigned_variable2])    
